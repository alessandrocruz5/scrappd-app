...
docker buildx build --platform linux/amd64 -t asia-southeast1-docker.pkg.dev/scrappd-prod/scrappd-repo/scrappd-api:v17 --push .
docker build --platform linux/amd64 -t scrappd-api:v17 .
docker tag scrappd-api:v17 asia-southeast1-docker.pkg.dev/scrappd-prod/scrappd-repo/scrappd-api:v17
docker push asia-southeast1-docker.pkg.dev/scrappd-prod/scrappd-repo/scrappd-api:v17

gcloud run deploy scrappd-api \
 --image=asia-southeast1-docker.pkg.dev/scrappd-prod/scrappd-repo/scrappd-api:v17 \
 --region=asia-southeast1 \
 --platform=managed \
 --memory=512Mi \
 --cpu=1 \
